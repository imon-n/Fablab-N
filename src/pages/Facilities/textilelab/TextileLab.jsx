...
import TextileEQP from "./TextileEQP";
import TextileFAQ from "./TextileFAQ";

export default function TextileLab() {
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              The Textile Lab supports garment prototyping, digital embroidery,
              pattern development, and smart textile innovation. Transform
              creative fashion ideas into functional products.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              {["Pattern Design", "Fabric Processing", "Final Stitching"].map(
                (step, index) => (
                  <div
                    key={index}
                  ...
                  >
                    ...
                    <p className="text-sm text-slate-600">
                      From creative sketch to finished textile product.
                    </p>
                  </div>
                )
              )}
              ...
              <div className="relative overflow-hidden rounded-2xl bg-black text-white p-6 shadow-xl">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-sm text-gray-300 mb-6">
                    Reserve your textile session and start building creative fabric projects.
                  </p>
