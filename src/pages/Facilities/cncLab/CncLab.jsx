...
import CncEquip from "./CncEquip";
import CncFAQ from "./CncFAQ";
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              Our {currentLab.label} provides high-precision subtractive
              manufacturing solutions. Using computer-controlled machining,
              users can fabricate components from wood, aluminum, plastics,
              and composite materials with exceptional accuracy and repeatability.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              {["CAD Design", "CAM Programming", "CNC Machining"].map(
                (step, index) => (
                  <div
                    key={index}
                  ...
                  >
                    ...
                    <p className="text-sm text-slate-600">
                      From digital modeling to automated precision cutting
                      and milling.
                    </p>
                  </div>
                )
              ...
              <div className="relative overflow-hidden rounded-2xl bg-black text-white p-6 shadow-xl">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-sm text-gray-300 mb-6">
                    Reserve your CNC machining session and bring your designs
                    to life with precision manufacturing.
                  </p>
