...
import BrainEQP from "./BrainEQP";
import BrainFAQ from "./BrainFAQ";
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              The {currentLab.label} empowers students and innovators to
              explore artificial intelligence, research-based problem solving,
              design thinking, and advanced computational systems.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              {["Ideation", "Prototype Development", "Testing & Optimization"].map(
                (step, index) => (
                  <div
                    key={index}
                  ...
                  >
                    ...
                    <p className="text-sm text-slate-600">
                      Structured innovation workflow for smart solutions.
                    </p>
                  </div>
                )
              )}
              ...
              <div className="relative overflow-hidden rounded-2xl bg-black text-white p-6 shadow-xl">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-sm text-gray-300 mb-6">
                    Reserve your innovation session and start building smart solutions.
                  </p>
