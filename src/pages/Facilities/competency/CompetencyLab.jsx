...
import CompetencyEQP from "./CompetencyEQP";
import CompetencyFAQ from "./CompetencyFAQ";

export default function CompetencyLab() {
      ...
      <section className="relative h-[420px] flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 text-white px-6 max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-white mb-4">
            <Typewriter
              words={["Competency Development Lab"]}
              loop={false}
              cursor
              cursorStyle="_"
              typeSpeed={60}
          ...
          <div className="lg:col-span-3">
            <h2 className="text-3xl md:text-4xl uppercase font-extrabold leading-tight mb-3">
              <span className="bg-gradient-to-r from-blue-600 to-cyan-400 bg-clip-text text-transparent">
                Skill Enhancement Hub
              </span>
            </h2>

            <p className="text-slate-600 leading-relaxed mb-6">
              Our {currentLab.label} is dedicated to developing technical,
              professional, and soft skills through structured workshops,
              hands-on training, and competency-based learning programs
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              {["Register", "Hands-on Training", "Assessment & Certification"].map(
                (step, index) => (
                  <div
                    key={index}
                  ...
                  >
                    ...
                    <p className="text-sm text-slate-600">
                      Structured competency-based learning workflow.
                    </p>
                  </div>
                )
              )}
              ...
              <div className="relative overflow-hidden rounded-2xl bg-black text-white p-6 shadow-xl">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-sm text-gray-300 mb-6">
                    Reserve your session and enhance your professional competencies.
                  </p>
