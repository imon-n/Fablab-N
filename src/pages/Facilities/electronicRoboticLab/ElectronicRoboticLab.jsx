...
import ElectronicFAQ from "./electronicFAQ";

export default function ElectronicRoboticsLab() {
      ...
      <section className="relative h-[420px] flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 text-white px-6 max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-white mb-4">
            <Typewriter
              words={["Electronics & Robotics Lab"]}
              loop={false}
              cursor
              cursorStyle="_"
              typeSpeed={60}
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              Our {currentLab.label} provides advanced tools for circuit
              design, embedded systems, IoT development, and robotics
              prototyping. Students and innovators can design, test, and deploy
              intelligent electronic systems in a collaborative environment.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              {["Design Circuit", "Build Prototype", "Test & Deploy"].map(
                (step, index) => (
                  <div
                    key={index}
                  ...
                  >
                    ...
                    <p className="text-sm text-slate-600">
                      Structured workflow from concept to intelligent system
                      deployment.
                    </p>
                  </div>
                )
              ...
              <div className="relative overflow-hidden rounded-2xl bg-black text-white p-6 shadow-xl">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-sm text-gray-300 mb-6">
                    Reserve your session in this lab and start building smart
