...
import NeedleEQP from "./NeedleEQP";
import NeedleFAQ from "./NeedleFAQ";

export default function NeedleLab() {
          ...
          <div className="lg:col-span-3">
            <h2 className="text-3xl md:text-4xl uppercase font-extrabold leading-tight mb-3">
              <span className="bg-gradient-to-r from-blue-600 to-cyan-400 bg-clip-text text-transparent">
                Textile Craft & Stitching Hub
              </span>
            </h2>

            <p className="text-slate-600 leading-relaxed mb-6">
              The {currentLab.label} provides modern sewing and textile
              fabrication facilities for garment construction, pattern
              development, embroidery, and fabric prototyping.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              {["Pattern Design", "Stitching & Assembly", "Finishing & Quality Check"].map(
                (step, index) => (
                  <div
                    key={index}
                  ...
                  >
                    ...
                    <p className="text-sm text-slate-600">
                      Structured garment development workflow.
                    </p>
                  </div>
                )
              )}
              ...
              <div className="relative overflow-hidden rounded-2xl bg-black text-white p-6 shadow-xl">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-sm text-gray-300 mb-6">
                    Reserve your slot for stitching and textile development sessions.
                  </p>
