...
import ThreedEquipment from "./ThreedEquipment";
import FAQ from "./FAQ_3d";
import { Typewriter } from "react-simple-typewriter";
import { facilities } from "../dataFacilities";

export default function T3DPrintinglab() {
  const location = useLocation();

  const currentLab = facilities.find((lab) => lab.to === location.pathname) || facilities[0];
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              Our {currentLab.label} empowers students, researchers,
              and innovators with advanced tools and expert guidance.Our {currentLab.label} empowers students, researchers,
              and innovators with advanced tools and expert guidance.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              {["Design", "Prototype", "Refine"].map((step, index) => (
                <div
                  key={index}
                ...
                >
                  ...
                  <p className="text-sm text-slate-600">
                    Professional workflow for innovation and creation.
                  </p>
                </div>
              ))}
            </div>
              ...
              <div className="relative overflow-hidden rounded-2xl bg-black text-white p-6 shadow-xl">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-sm text-gray-300 mb-6">
                    Reserve your session in this lab and start building today.
                  </p>
                  <Btn>Book a Slot</Btn>
                </div>
              </div>
