...
import GraphicsEQP from "./GraphicsEQP";
import GraphicsFAQ from "./GraphicsFAQ";
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              The Graphics Lab provides professional tools for digital design,
              branding, UI/UX development, illustration, and multimedia content
              creation. Transform ideas into compelling visual experiences.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              {["Concept Design", "Digital Creation", "Final Export"].map(
                (step, index) => (
                  <div
                    key={index}
                  ...
                  >
                    ...
                    <p className="text-sm text-slate-600">
                      From idea sketching to professional-quality output.
                    </p>
                  </div>
                )
              )}
              ...
              <div className="relative overflow-hidden rounded-2xl bg-black text-white p-6 shadow-xl">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-sm text-gray-300 mb-6">
                    Book your design session and start creating visually
                    impactful projects.
                  </p>
